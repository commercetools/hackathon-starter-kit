...
export type PaymentUpdateAction = PaymentAddInterfaceInteractionAction | PaymentAddTransactionAction | PaymentChangeAmountPlannedAction | PaymentChangeTransactionInteractionIdAction | PaymentChangeTransactionStateAction | PaymentChangeTransactionTimestampAction | PaymentSetAnonymousIdAction | PaymentSetCustomFieldAction | PaymentSetCustomTypeAction | PaymentSetCustomerAction | PaymentSetInterfaceIdAction | PaymentSetKeyAction | PaymentSetMethodInfoAction | PaymentSetMethodInfoCustomFieldAction | PaymentSetMethodInfoCustomTypeAction | PaymentSetMethodInfoInterfaceAccountAction | PaymentSetMethodInfoInterfaceAction | PaymentSetMethodInfoMethodAction | PaymentSetMethodInfoNameAction | PaymentSetMethodInfoTokenAction | PaymentSetStatusInterfaceCodeAction | PaymentSetStatusInterfaceTextAction | PaymentSetTransactionCustomFieldAction | PaymentSetTransactionCustomTypeAction | PaymentTransitionStateAction;
 ...
 *
 */
export declare enum TransactionStateValues {
    Failure = "Failure",
    Initial = "Initial",
    Pending = "Pending",
    Success = "Success"
...
export declare enum TransactionTypeValues {
