...
export declare enum AttributionSourceValues {
    Export = "Export",
    Import = "Import"
}
...
export type _BaseResource = BaseResource | ApprovalFlow | ApprovalRule | AssociateRole | AttributeGroup | BusinessUnit | Cart | CartDiscount | Category | Channel | CustomObject | Customer | CustomerGroup | DiscountCode | DiscountGroup | Extension | InventoryEntry | Message | _Order | OrderEdit | Payment | PaymentMethod | Product | ProductDiscount | ProductProjection | ProductSelection | ProductTailoring | ProductType | Quote | QuoteRequest | RecurrencePolicy | RecurringOrder | Review | ShippingMethod | ShoppingList | StagedQuote | StandalonePrice | State | Store | Subscription | TaxCategory | Type | Zone;
/**
 ...
 *
 */
export type ResourceIdentifier = AssociateRoleResourceIdentifier | AttributeGroupResourceIdentifier | BusinessUnitResourceIdentifier | CartDiscountResourceIdentifier | CartResourceIdentifier | CategoryResourceIdentifier | ChannelResourceIdentifier | CustomerGroupResourceIdentifier | CustomerResourceIdentifier | DiscountCodeResourceIdentifier | DiscountGroupResourceIdentifier | InventoryEntryResourceIdentifier | OrderEditResourceIdentifier | PaymentResourceIdentifier | ProductDiscountResourceIdentifier | ProductResourceIdentifier | ProductSelectionResourceIdentifier | ProductTailoringResourceIdentifier | ProductTypeResourceIdentifier | QuoteRequestResourceIdentifier | QuoteResourceIdentifier | RecurrencePolicyResourceIdentifier | RecurringOrderResourceIdentifier | ReviewResourceIdentifier | ShippingMethodResourceIdentifier | ShoppingListResourceIdentifier | StagedQuoteResourceIdentifier | StandalonePriceResourceIdentifier | StateResourceIdentifier | StoreResourceIdentifier | TaxCategoryResourceIdentifier | TypeResourceIdentifier | ZoneResourceIdentifier;
