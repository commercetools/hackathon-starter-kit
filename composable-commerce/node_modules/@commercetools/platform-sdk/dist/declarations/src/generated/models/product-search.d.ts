...
export declare enum ProductSearchFacetCountLevelEnumValues {
    Products = "products",
    Variants = "variants"
}
...
export declare enum ProductSearchFacetDistinctBucketSortByValues {
    Count = "count",
    Key = "key"
}
...
export type _ProductSearchFacetExpression = ProductSearchFacetExpression | ProductSearchFacetCountExpression | ProductSearchFacetDistinctExpression | ProductSearchFacetRangesExpression | ProductSearchFacetStatsExpression;
...
export type _ProductSearchFacetResult = ProductSearchFacetResult | ProductSearchFacetResultBucket | ProductSearchFacetResultCount | ProductSearchFacetResultStats;
/**
...
export declare enum ProductSearchFacetScopeEnumValues {
    All = "all",
    Query = "query"
}
